...
/** Function to initialize the list metadata head to the appropriate function
 *pointers. Allocates memory to the struct.
...
/**Returns a string that contains a string representation of the list traversed
from  head to tail. Utilize an iterator and the list's printData function
 ...
 **/
int getLength(List list) { return list.length; }
