...
/**
    Clip stores a reference to a video file and its data within an editing
   sequence. This way, we can access the AVPackets whenever needed, and further
...
typedef struct Clip {
  ...
  */
  ...
  /*
      ...
      by default, end_pts will be automatically set to size by orig_end_pts in
     move_clip()
  */
...
/**
   ...
   error. AVPacket is returned in param pkt.
*/
